...
folder_path = f'Jumbo_{current_time}/'
...
def scraping():
    ...
    for cat in categories:
        ...
        save_to_s3(df_categories, folder_path + 'df_categorias_jumbo.xlsx')
        save_to_s3(total_url_sku, folder_path + f'df_info_products_{cat1}_jumbo.xlsx')
        save_to_s3(df_producto_t, folder_path + f'results_ws_{cat1}_jumbo.xlsx')
        save_to_s3(df_report, folder_path + f'REPORTE_WS_{cat1}_JUMBO.xlsx')
        #################################################
        # Carga a STORAGE
        #################################################
